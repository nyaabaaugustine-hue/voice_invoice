...
const App = (() => {
  ...
  return { showPage, updateHeaderBiz, showLoading, hideLoading, toast, toggleMic, handleInput };
})();
...
const Voice = (() => {
  ...
  function toggleType() {
    document.getElementById('typeRow').classList.toggle('show');
  }
